...
//In this activity, it shows how to send ether to thge other address and the other address should add 1. Also it shows the creation ti,e getbalance, initial eth, owner and remaining eth.